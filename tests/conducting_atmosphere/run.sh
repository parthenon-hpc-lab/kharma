...
conv_2d() {
    ...
    do
        ...
        # Run this with more cores, it's looooooong
        ...
        $BASE/run.sh -d . -i ./conducting_atmosphere.par debug/verbose=1 \
            ...
            parthenon/meshblock/nx1=$res parthenon/meshblock/nx2=$blocksize parthenon/meshblock/nx3=1 \
